...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	private void addTab(String text, int resId, int index) {
		//Workaround for not being able to pass a defStyle on pre-3.0
		final TabView tabView = (TabView)mInflater.inflate(R.layout.vpi__tab, null);
		tabView.init(this, text, resId, index);
	...
	public void notifyDataSetChanged() {
		...
		if (adapter instanceof TitleAndImageProvider) {
			for (int i = 0; i < count; i++) {
				addTab(adapter.getTitle(i), ((TitleAndImageProvider)adapter).getImageResource(i), i);
			}
		} else {
			for (int i = 0; i < count; i++) {
	...
	public static class TabView extends LinearLayout {
		...
		public void init(TabPageIndicator parent, String text, int resId, int index) {
			mParent = parent;
			mIndex = index;
			...
			ImageView iconView = (ImageView)findViewById(android.R.id.icon1);
